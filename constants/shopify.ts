...
const PROJECT_TYPE = "Shopify website Laten Ontwerpen";

export const SHOPIFY_PROJECT_TYPE = PROJECT_TYPE;

export const SHOPIFY_META = {
  path: "/shopify-website-laten-ontwerpen",
  title: "Shopify website Laten Ontwerpen Voor Bedrijven | Sarte Global",
  description:
    "Shopify website Laten Ontwerpen laten maken door specialisten. Een snelle, betrouwbare en schaalbare e-commerce website met professioneel maatwerk Shopify-thema. Vraag een voorstel aan.",
  keywords: [
  ...
  ogAlt: "Shopify website Laten Ontwerpen laten ontwerpen · Sarte Global",
} as const;

export const SHOPIFY_HERO = {
  eyebrow: "Shopify website Laten Ontwerpen · Sarte Global",
  badge: "Shopify-specialist · nu 3 plekken beschikbaar",
  titleLead: "Shopify website Laten Ontwerpen laten maken die",
  titleEm: "snel live is en verkoopt.",
  sub: "Sarte Global bouwt snelle, conversiegerichte Shopify websites Laten Ontwerpen met een uniek thema. Betrouwbaar gehost, weinig onderhoud en klaar om te schalen — zodat jij je op verkopen kunt richten.",
  primaryCta: "Shopify website Laten Ontwerpen aanvragen",
...
export const SHOPIFY_COMPARISON = {
  ...
  rows: [
    {
      label: "Design Laten Ontwerpen van jouw merk",
      us: "Volledig uniek",
...
export const SHOPIFY_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Ja. Shopify heeft een overzichtelijk dashboard waarmee je producten, prijzen, voorraad en bestellingen eenvoudig beheert. We geven een korte uitleg Laten Ontwerpen, en je kunt het beheer ook aan ons uitbesteden.",
  },
  {
...
export const SHOPIFY_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je producten en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je Shopify webshop laten maken — helder en Laten Ontwerpen.",

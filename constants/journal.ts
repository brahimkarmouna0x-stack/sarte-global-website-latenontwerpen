...
/**
 * Extended article references — these slugs exist in content/journal/*.mdx
 * and are surfaced via getAllPosts() on the journal listing page and sitemap.
 * They are listed here so editors can see which articles are live.
 *
 * Slugs added in the June 2026 blog expansion:
 *  - responsive-website-laten-maken
 *  - website-redesign-laten-maken
 *  - zakelijke-website-voor-mkb
 *  - website-kosten-2026
 *  - nextjs-vs-wordpress-website
 *  - website-onderhoud-belang
 *  - conversie-website-tips
 *  - website-seo-checklist-2026
 *  - ux-design-website-gebruikerservaring
 *  - bedrijfswebsite-laten-maken-checklist
 */

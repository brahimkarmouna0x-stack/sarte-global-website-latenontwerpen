...
export const HERO_STAGE_SLIDES = [
  {
    ...
    description:
      "Filmische montage voor lanceringen, advertenties en social proof.",
    image:
  ...
  },
  {
    ...
    description:
      "Redactionele layouts, dienstenpagina's en conversiegerichte contentsystemen.",
    image:
  ...
  },
  {
    ...
    description:
      "Scherpe hero-secties, voordelen, social proof, prijzen en duidelijke actiepaden.",
    image:
  ...
  },
  {
    ...
    description:
      "Premium pagina's die jouw expertise verpakken en gekwalificeerde verkoop opleveren.",
    image:
  ...
  },
  {
    ...
    description:
      "Productverhalen, vertrouwenssignalen, checkout-flow en UX voor terugkerende klanten.",
    image:
  ...
  },
  {
    ...
    description:
      "Positionering, UI-verhalen, featuresecties en demo-gedreven journeys.",
    image:
  ...
  },
  {
    ...
    description:
      "Themes Laten Ontwerpen, collectiepagina's, productpagina's en conversiedetails.",
    image:
  ...
  },
  {
    ...
    description:
      "Menu's, reserveringen, kaarten, WhatsApp-knoppen, reviews en vertrouwenspagina's.",
    image:

...
export const LANDING_INSPIRATION: readonly LandingInspirationItem[] = [
  ...
  },
  {
    ...
    strengths: [
      ...
      "Gepersonaliseerde bonus",
      "Vlekkeloze bezorgflow",
    ],
    trust:
  ...
  },
  {
    ...
    strengths: [
      "Inspirerende fotografie",
      "Achteraf betalen",
      "Sterke filters & maatadvies",
    ],
    trust:
...
export const LANDING_CASES: readonly LandingCaseItem[] = [
  {
    ...
    summary:
      "Een complete redesign met focus op conversie en moderne uitstraling.",
    metrics: [
  ...
  },
  {
    ...
    summary:
      "Gerichte landingspagina die bezoekers moeiteloos naar contact leidt.",
    metrics: [
...
export const LANDING_WHY_STATS: readonly LandingStatCard[] = [
  ...
  },
  {
    ...
    title: "Snel live",
    description:
      "Van kickoff tot livegang — zonder in te leveren op kwaliteit.",
  },
];
...
export const LANDING_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je bedrijf en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel — helder, Laten Ontwerpen en zonder verplichtingen.",
  urgency: "Nog 3 projectplekken beschikbaar deze maand",
  points: [
    "Reactie binnen 1 werkdag",
    "Vrijblijvend & volledig Laten Ontwerpen",

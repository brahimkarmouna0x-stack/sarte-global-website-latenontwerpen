...
const PROJECT_TYPE = "WooCommerce website Laten Ontwerpen";

export const WOOCOMMERCE_PROJECT_TYPE = PROJECT_TYPE;

export const WOOCOMMERCE_META = {
  path: "/woocommerce-website-laten-ontwerpen",
  title: "WooCommerce website Laten Ontwerpen Specialist | Sarte Global",
  description:
    "WooCommerce website Laten Ontwerpen laten maken door specialisten. Een snelle, schaalbare e-commerce website op WordPress, volledig van jou en zonder platform-lock-in. Vraag een voorstel aan.",
  keywords: [
  ...
  ogAlt: "WooCommerce website Laten Ontwerpen laten ontwerpen · Sarte Global",
} as const;

export const WOOCOMMERCE_HERO = {
  eyebrow: "WooCommerce website Laten Ontwerpen · Sarte Global",
  badge: "WooCommerce-specialist · nu 3 plekken beschikbaar",
  titleLead: "WooCommerce website Laten Ontwerpen laten maken die",
  titleEm: "volledig van jou is.",
  sub: "Sarte Global bouwt snelle, schaalbare WooCommerce websites Laten Ontwerpen op WordPress. Geen maandelijkse omzetafdracht, geen platform-lock-in — wel volledige controle over je website, je data en je groei.",
  primaryCta: "WooCommerce website Laten Ontwerpen aanvragen",
...
export const WOOCOMMERCE_WHY = {
  ...
  lead: "WooCommerce draait wereldwijd op miljoenen webshops en is gebouwd op WordPress — het meest gebruikte CMS ter wereld. Je krijgt een professionele webshop Laten Ontwerpen, zonder de maandelijkse kosten en beperkingen van gesloten platforms.",
  media: {
...
export const WOOCOMMERCE_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Ja. Je beheert producten, prijzen, voorraad en bestellingen via het vertrouwde WordPress-dashboard. We geven een korte uitleg Laten Ontwerpen, en je kunt het beheer ook volledig aan ons uitbesteden.",
  },
  {
...
export const WOOCOMMERCE_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je producten en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je WooCommerce webshop laten maken — helder en Laten Ontwerpen.",
  urgency: "Nog 3 projectplekken beschikbaar deze maand",
  points: [
    "Reactie binnen 1 werkdag",
    "Volledig eigenaarschap & Laten Ontwerpen",

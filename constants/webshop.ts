...
const PROJECT_TYPE = "E-commerce oplossingen";

export const WEBSHOP_PROJECT_TYPE = PROJECT_TYPE;

export const WEBSHOP_META = {
  path: "/ecommerce-oplossingen",
  title: "Professionele E-commerce Oplossingen Laten Ontwerpen | Sarte Global",
  description:
    "Professionele e-commerce oplossingen Laten Ontwerpen door Sarte Global. Snelle en schaalbare webshops gebouwd om te verkopen. Vraag vrijblijvend een voorstel aan.",
  keywords: [
  ...
  ogAlt: "E-commerce oplossingen · Sarte Global",
} as const;
...
export const WEBSHOP_WHY = {
  ...
  lead: "WooCommerce is het meest gebruikte e-commerceplatform ter wereld, gebouwd op WordPress. Je krijgt een professionele webshop Laten Ontwerpen, zonder maandelijkse transactiekosten van gesloten platforms en zonder limieten op groei.",
  media: {
...
export const WEBSHOP_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Ja. Je krijgt een overzichtelijk dashboard waarin je producten, prijzen, voorraad en bestellingen eenvoudig beheert. We geven een korte uitleg Laten Ontwerpen, en je kunt het beheer ook aan ons uitbesteden.",
  },
  {
...
export const WEBSHOP_FINAL_CTA = {
  ...
  sub: "Vertel ons kort over je producten en doelen. Binnen één werkdag ontvang je een vrijblijvend voorstel voor je webshop laten maken — helder en Laten Ontwerpen.",
  urgency: "Nog 3 projectplekken beschikbaar deze maand",
  points: [
    "Reactie binnen 1 werkdag",
    "Conversiegericht & Laten Ontwerpen",

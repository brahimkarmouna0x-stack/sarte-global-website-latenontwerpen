...
/**
 * Generic WebPage JSON-LD. Use on informational pages (About, Contact, Services
 * hub) to give Google a typed entity for the page distinct from the parent
 * WebSite / Organization nodes.
 */
...
/**
 * CollectionPage / Blog JSON-LD for the journal listing page. Links the blog
 * to the publisher Organization so Google can surface it in Knowledge Panels.
 */
